# -----------------------------------------------------------------------------
# DEPS file for bin2src-tools scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# bin2src-tools-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'bin2src-tools': 'https://github.com/KageKirin/bin2src-tools.git@{bin2src-tools_revision}',
  # keep
  # this
  # line
}
